...
bash $TEA_HOME/src/notes/utilities/pre_processing/py4j_newsreader/compile_tok.sh
bash $TEA_HOME/src/notes/utilities/pre_processing/py4j_newsreader/compile_pos.sh
bash $TEA_HOME/src/notes/utilities/pre_processing/py4j_newsreader/compile_ner.sh
bash $TEA_HOME/src/notes/utilities/pre_processing/py4j_newsreader/compile_parse.sh
bash $TEA_HOME/src/notes/utilities/pre_processing/py4j_newsreader/compile_py4j.sh
