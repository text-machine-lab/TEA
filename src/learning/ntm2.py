...
from keras.layers import TimeDistributed, Dense, Input, Dropout
...
class SimpleNTM(NeuralTuringMachine):
    ...
    def build(self, input_shape):
        ...
        print("m_depth overritten by controller output_dim!")
    ...
    def step(self, x, states):
        ...
        # Keys_t = self._direct_write(_renorm(ww_t ** 5), k_write, Keys_tm1)
