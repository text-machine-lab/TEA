...
def getWordShapes(word):
    return {"shape1":wordShapeChris1(word), "shape2":wordShapeDan1(word),
             "shape3":wordShapeJenny1(word), "shape4":wordShapeChris2(word, False, None),
             "shape5":wordShapeDan2(word, None)}

if __name__ == "__main__":

    print getWordShapes("1998")
