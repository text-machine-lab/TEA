...
'''
  I DO NOT CLAIM AUTHORSHIP OF THIS CODE. I FOUND IT ON GITHUB.
...
def getNegationArray(doc, windowsize, debugmode=False, postag=False):
    '''
...
def is_negated(sentence, token):
    ...
    index = {token:i for i, token in enumerate(sentence)}

    return getNegationArray(sentence, 4)[index[token]]


if __name__ == "__main__":
    print is_negated(["he","did", "not", "begin"], 'begin')
